****
  @page Window-App-SBSFU

  @verbatim
  ********************************************************************************************
  * @file    Matter/Window-App-SBSFU
  * @author  MCD Application Team
  * @brief   Description of the Window App SBSFU application for Matter OTA Framework
  ********************************************************************************************
  *
...
Window-App-SBSFU is the same as Window-App but is used in SBSFU environment.
...
To setup the application :
   ...
   a)  Open all projects and build them in the following order: BLE_ota, Secure Engine, SBSFU then Window-App-SBSFU.
   ...
   d)  Load your generated SBSFU_Window-App-SBSFU.bin application for M4 core on your STM32WB devices. 
   ...
   e) The principal goal of OTA is change the actually software version "n" running on device with a new version "n+1". The following step is required to generate .ota file:
        1- Change software version in Projects\STM32WB5MM-DK\Applications\Matter\Window-App-SBSFU\Core\Inc\CHIPProjectConfig.h
        2- Get M4 application .sfb binary : Projects\STM32WB5MM-DK\Applications\Matter\Window-App-SBSFU\Binary\Window-App-SBSFU.sfb
        3- Use CreateMatterBin.py to concatenate M0 and M4 binaries and generate the final bin for update provider.
           => python CreateMatterBin.py -m4 Window-App-SBSFU.sfb -m0 stm32wb5x_BLE_Thread_light_dynamic_fw.bin
...
@par Directory contents 
  ...
  Files same as Window-App + SBSFU files + OTA files  
...
In order to make the program work, you must do the following: 
 ...
 - Open STM32CubdeIDE
 - Build all projects (BLE_ota, Secure Engine, SBSFU then Window-App-SBSFU) in this order. Two files (Window-App-SBSFU.sfb and SBSFU_Window-App-SBSFU.bin) are available under binary\ folder into Window-App-SBSFU\ directory. 
 - Window-App-SBSFU.sfb contains only the application binary to be used to flash new image through OTA. 
 - Using CubeProgrammer: 
   ...
   - Flash application software (M4) :  STM32WB-Matter-BLE-Thread\Projects\STM32WB5MM-DK\Applications\Matter\Window-App-SBSFU\Binary\SBSFU_Window-App-SBSFU.bin
 - To initiate OTA testing:
   - Modify the STM32WB-Matter-BLE-Thread\Projects\STM32WB5MM-DK\Applications\Matter\Window-App-SBSFU\Core\Inc\CHIPProjectConfig.h to change software version.
