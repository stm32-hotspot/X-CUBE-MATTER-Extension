...
/**
  * @brief  Get the info of CM0 stack
  * @note
  * @param  None
  * @retval None
  */
void CM0_GetFWInfo(WirelessFwInfo_t* pWirelessInfo)
{
  SHCI_GetWirelessFwInfo( pWirelessInfo );
}
...
static SE_ErrorStatus SE_CM0_Update_Continue(void)
{
  ...
  switch(fus_state_value)
  {
    case FUS_STATE_VALUE_ERROR :
      ...
      if (STANDALONE_LOADER_STATE == STANDALONE_LOADER_BYPASS_AND_INSTALL_REQ)
      {
...
SE_ErrorStatus CM0_Update(void)
{
      ...
      (STANDALONE_LOADER_STATE == STANDALONE_LOADER_BYPASS_REQ_AND_INSTALL_REQ))
  {
    ...
    {
      STANDALONE_LOADER_STATE = STANDALONE_LOADER_BYPASS;
    }
    if (STANDALONE_LOADER_STATE == STANDALONE_LOADER_BYPASS_REQ_AND_INSTALL_REQ)
    {
