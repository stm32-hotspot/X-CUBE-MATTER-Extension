...
/**
  ...
  */
#if !defined(SFU_TEST_PROTECTION)
#define SECBOOT_LOADER SECBOOT_USE_STANDALONE_LOADER /*!< Loader selection inside SBSFU : local/standalone/none */
#else
...
/* Multi-images configuration :
   ...
   - FW image valid all features authorized from master slot
*/
