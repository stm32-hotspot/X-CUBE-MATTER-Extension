...
extern uint32_t __ICFEDIT_SB_FWIMG_STATE_region_RAM_start__ ;
#define SB_FWIMG_STATE_REGION_RAM_START ((uint32_t)& __ICFEDIT_SB_FWIMG_STATE_region_RAM_start__)
extern uint32_t __ICFEDIT_SB_FWIMG_STATE_region_RAM_end__ ;
#define SB_FWIMG_STATE_REGION_RAM_END ((uint32_t)& __ICFEDIT_SB_FWIMG_STATE_region_RAM_end__)
...
extern uint32_t __ICFEDIT_SLOT_Dwl_4_start__;
#define SLOT_DWL_4_START ((uint32_t)& __ICFEDIT_SLOT_Dwl_4_start__)
extern uint32_t __ICFEDIT_SLOT_Dwl_4_end__;
#define SLOT_DWL_4_END ((uint32_t)& __ICFEDIT_SLOT_Dwl_4_end__)
...
extern uint32_t __ICFEDIT_BACKUP_start__;
#define BACKUP_START ((uint32_t)& __ICFEDIT_BACKUP_start__)
extern uint32_t __ICFEDIT_BACKUP_end__;
#define BACKUP_END ((uint32_t)& __ICFEDIT_BACKUP_end__)
