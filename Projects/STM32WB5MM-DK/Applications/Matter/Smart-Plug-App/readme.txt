...
The STM32WB5MM-DK board running smart-plug-app application is capable 
...
- 1 STM32WB5MM-DK board with Smart_plug_App firmware.
...
LCD Mapping :
 ...
 - The LCD screen displays "LED ON" when using "LIGHT ON/OFF" 
