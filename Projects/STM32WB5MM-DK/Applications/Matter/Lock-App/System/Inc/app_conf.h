 ...
 * The following definition shall not be modified
 */
#define USE_CUSTOM_IPCC_HANDLER 1
...
#define CFG_IWD_SBSFU_EVT_PROCESS_NAME        "IWD_SBSFU_EVT_PROCESS"
#define CFG_IWD_SBSFU_EVT_PROCESS_ATTR_BITS   (0)
#define CFG_IWD_SBSFU_EVT_PROCESS_CB_MEM      (0)
#define CFG_IWD_SBSFU_EVT_PROCESS_CB_SIZE     (0)
#define CFG_IWD_SBSFU_EVT_PROCESS_STACK_MEM   (0)
#define CFG_IWD_SBSFU_EVT_PROCESS_PRIORITY    osPriorityLow
#define CFG_IWD_SBSFU_EVT_PROCESS_STACK_SIZE  (128*4)
...
#if (OTA_SUPPORT == 1)
/* IWDG is required for SBSFU projects, init is done by SBSFU application. */
#define ENABLE_IWDG_SUPPORT 1 /* do not change this value */
#define ENABLE_IWDG_INIT 0    /* do not change this value */
#else
/* IWDG is optional for non-SBSFU projects but init must be done by user App in this case. */
#define ENABLE_IWDG_SUPPORT 0 /* User can modify this value*/
/* automatically set ENABLE_IWDG_INIT value depending of user choice. */
#define ENABLE_IWDG_INIT (ENABLE_IWDG_SUPPORT == 1 ? 1 : 0)
#endif /* (OTA_SUPPORT == 1) */
...
#define CFG_RGB_LED_SUPPORTED 1
#endif
