...
private:
    friend AppTask & GetAppTask(void);
       ...
       static void TimerNvmEventHandler(TimerHandle_t xTimer);
       static void TimerPB2EventHandler(TimerHandle_t xTimer);
       static void MatterEventHandler(const chip::DeviceLayer::ChipDeviceEvent * event, intptr_t arg);	      
       static void DelayNvmHandler(void);
       static void UpdateLCD(void);
       static void UpdateLEDs(void);
       static void UpdateNvmEventHandler(AppEvent * aEvent);
       static void UpdateGenericSwitchEventHandler(AppEvent * aEvent);
