...
#define APP_NAME "Smart-plug-app"
...
private:
    friend AppTask & GetAppTask(void);
       static void ActionInitiated(SmartPlugManager::Action_t aAction);
       static void ActionCompleted(SmartPlugManager::Action_t aAction);
       void CancelTimer(void);
       void DispatchEvent(AppEvent * event);
       static void FunctionHandler(AppEvent * aEvent);
       static void SmartPlugActionEventHandler(AppEvent * aEvent);
