...
#else
/* Value for MATTER with External FLASH support = 0x1C6000 For Internal FLASH only, use 0xE0000. */
#define FLASH_NS_PARTITION_SIZE         (0x1C6000)
...
#else
/* Value for MATTER with Internal or External FLASH support. */
