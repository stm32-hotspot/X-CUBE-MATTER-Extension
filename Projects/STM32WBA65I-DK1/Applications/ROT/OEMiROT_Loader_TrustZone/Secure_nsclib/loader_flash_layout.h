...
#define FLASH_AREA_1_SIZE              0xE0000   /* Non-secure app image primary slot size */

#define FLASH_AREA_2_OFFSET            0xFE000  /* Secure app image secondary slot */

#define FLASH_AREA_2_SIZE              0x6000   /* Secure app image secondary slot size */

#define FLASH_AREA_3_OFFSET            0x104000 /* Non-secure app image secondary slot offset */

#define FLASH_AREA_3_SIZE              0xE0000   /* Non-secure app image secondary slot size */
...
#define FLASH_PARTITION_SIZE           0xE6000  /* Secure and Non Secure partition size */

#define FLASH_NS_PARTITION_SIZE        0xE0000  /* Non Secure partition size */
