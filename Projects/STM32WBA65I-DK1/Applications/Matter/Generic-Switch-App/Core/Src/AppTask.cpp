...
void AppTask::ButtonEventHandler(ButtonDesc_t *Button) {
    ...
    if (Button->button == B1) { /* JOY_UP */
         ...
         if (Button->longPressed) sAppTask.mFunction = kFunction_FactoryReset;
    ...
    if (Button->button == B3) {/* JOY_RIGHT */
    	 ...
    	 if (Button->State) {
    		 if (Button->longPressed) {
			  ...
			  sAppTask.mFunction = kFunction_InitialPress;
			}
		  }
		  else {
			  if (Button->longPressed) {
