...
def do_trans(args):
    ...
    if args.assembly=="ARM" or args.assembly=="IAR" or args.assembly=="GNU":
        if args.version=="V6M" or args.version=="V7M": 
          out = key.trans(args.section, args.function, end, args.reverse, args.assembly, args.version)
          print (str(out))
        else:
...
def args():
    ...
    trans.add_argument('-r', '--reverse',help='reverse the order of key data', metavar='reverse', type=bool, required = False, default=False)
