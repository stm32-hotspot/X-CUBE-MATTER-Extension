...
\
  /* 14 - UserActiveModeTriggerInstruction, */\
...
\
  ...
  { ZAP_SIMPLE_DEFAULT(0x0004), 0x00000009, 2, ZAP_TYPE(BITMAP16), 0 }, /* SupportedThreadFeatures */  \
...
\
  ...
  { ZAP_SIMPLE_DEFAULT(0x110D), 0x00000006, 4, ZAP_TYPE(BITMAP32), 0 }, /* UserActiveModeTriggerHint */  \
  { ZAP_LONG_DEFAULTS_INDEX(14), 0x00000007, 129, ZAP_TYPE(CHAR_STRING), 0 }, /* UserActiveModeTriggerInstruction */  \
...
\
  ...
  { ZAP_SIMPLE_DEFAULT(0x000E), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), 0 }, /* FeatureMap */  \
  { ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U), 0 }, /* ClusterRevision */  \
}
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 18, 346 }, \
  { ZAP_CLUSTER_INDEX(18), 4, 24 }, \
}
...
#define FIXED_DEVICE_TYPES {{0x00000016,1},{0x0000000F,1}}
