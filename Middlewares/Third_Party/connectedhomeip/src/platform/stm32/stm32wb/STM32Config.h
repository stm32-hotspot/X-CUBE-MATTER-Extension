...
public:
    ...
    // Counter keys
    static constexpr Key kCounterKey_RebootCount = 60;
    static constexpr Key kCounterKey_UpTime = 61;
    static constexpr Key kCounterKey_TotalOperationalHours = 62;
    static constexpr Key kCounterKey_BootReason = 63;
    // Set key id limits for each group.
    static constexpr Key kConfigKey_Base = kConfigKey_SerialNum;
    static constexpr Key kConfigKey_Max = kCounterKey_BootReason;
