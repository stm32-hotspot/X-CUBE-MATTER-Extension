...
//#define CHIP_PLATFORM_CONFIG_INCLUDE <platform/stm32/stm32wba/CHIPPlatformConfig.h>
#define SYSTEM_PROJECT_CONFIG_INCLUDE <CHIPProjectConfig.h>
#define SYSTEM_PLATFORM_CONFIG_INCLUDE <platform/stm32/stm32wba/SystemPlatformConfig.h>
